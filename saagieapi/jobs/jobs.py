...
class Jobs:
    ...
    def get_job_technology(self, tech_id: str):
        result = self.saagie_api.client.execute(query=gql(GQL_GET_TECHNOLOGY), variable_values={"id": tech_id})
        logging.info("✅ Job technologie [%s] successfully retrieved", id)
        return result
